...
import { Truck, MapPin, ChevronRight, Package, Clock, RotateCcw } from 'lucide-react';
      ...
      <div className="bg-white px-6 py-8 border-b border-gray-100 sticky top-0 z-10 shadow-sm">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          ...
          <div className="bg-orange-50 p-4 rounded-3xl border border-orange-100">
            ...
            <p className="text-xl font-black text-orange-600">{orders.filter(o => ['picked_up', 'in_transit', 'delivering'].includes(o.status)).length}</p>
          </div>
        ...
        <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
          {['all', 'pending', 'picked_up', 'delivering', 'delivered'].map((f) => (
            <button
              key={f}
              onClick={() => setFilter(f)}
